...
var $author$project$Gen$Route$HarumiMurakami__Home_ = {$: 'HarumiMurakami__Home_'};
...
var $author$project$Gen$Params$HarumiMurakami$Home_$parser = A2(
	$elm$url$Url$Parser$slash,
	$elm$url$Url$Parser$s('harumi-murakami'),
...
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$HarumiMurakami__Home_, $author$project$Gen$Params$HarumiMurakami$Home_$parser)
	]);
...
var $author$project$Gen$Model$HarumiMurakami__Home_ = F2(
	function (a, b) {
		return {$: 'HarumiMurakami__Home_', a: a, b: b};
	});
var $author$project$Gen$Msg$HarumiMurakami__Home_ = function (a) {
	return {$: 'HarumiMurakami__Home_', a: a};
};
...
var $author$project$UI$red = A3($mdgriffith$elm_ui$Element$rgb255, 246, 52, 32);
var $author$project$View$none = {
	element: A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$UI$red),
...
var $author$project$Pages$HarumiMurakami$Home_$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$Pages$HarumiMurakami$Home_$animator = A3(
...
var $author$project$Pages$HarumiMurakami$Home_$Default = {$: 'Default'};
var $author$project$Models$Book$allBooks = _List_fromArray(
	[
		{imageUrl: 'book1-large.png', reviews: 1604, stars: 4, title: 'The Wind-Up Bird Chronicle'},
		{imageUrl: 'book2-large.png', reviews: 1718, stars: 4, title: '1Q84 - Book 1,2,3'},
		{imageUrl: 'book3-large.png', reviews: 616, stars: 5, title: 'Kafka on the Shore'},
		{imageUrl: 'book4-large.jpeg', reviews: 616, stars: 5, title: 'The Elephant Vanishes'},
		{imageUrl: 'book5-large.jpeg', reviews: 616, stars: 5, title: 'South of the Border, West of the Sun'}
	]);
...
var $author$project$Pages$HarumiMurakami$Home_$init = F2(
	function (req, _v0) {
		return _Utils_Tuple2(
			{
				animationData: $elm$core$Maybe$Nothing,
				books: $author$project$Models$Book$allBooks,
				fast: true,
				lastBook: $elm$core$Maybe$Nothing,
				req: req,
				state: $mdgriffith$elm_animator$Animator$init($author$project$Pages$HarumiMurakami$Home_$Default)
			},
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Pages$HarumiMurakami$Home_$BookOpen = F3(
	function (a, b, c) {
		return {$: 'BookOpen', a: a, b: b, c: c};
	});
var $author$project$Pages$HarumiMurakami$Home_$NoOp = {$: 'NoOp'};
var $author$project$Pages$HarumiMurakami$Home_$UpdateSelectBookLocations = function (a) {
	return {$: 'UpdateSelectBookLocations', a: a};
};
...
var $author$project$Pages$HarumiMurakami$Home_$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'Tick':
				var newTime = msg.a;
				return _Utils_Tuple2(
					A3($mdgriffith$elm_animator$Animator$update, newTime, $author$project$Pages$HarumiMurakami$Home_$animator, model),
					$elm$core$Platform$Cmd$none);
			case 'SelectBook':
				var index = msg.a;
				var book = msg.b;
				var selectedBookId = 'book-' + $elm$core$String$fromInt(index);
				var pageId = 'page';
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							lastBook: $elm$core$Maybe$Just(book),
							state: model.fast ? A3(
								$mdgriffith$elm_animator$Animator$go,
								$mdgriffith$elm_animator$Animator$verySlowly,
								A3($author$project$Pages$HarumiMurakami$Home_$BookOpen, index, book, false),
								model.state) : A3(
								$mdgriffith$elm_animator$Animator$go,
								$mdgriffith$elm_animator$Animator$millis(4000),
								A3($author$project$Pages$HarumiMurakami$Home_$BookOpen, index, book, false),
								model.state)
						}),
					A2(
						...
						function (result) {
							if (result.$ === 'Err') {
								return $author$project$Pages$HarumiMurakami$Home_$NoOp;
							} else {
								var _v2 = result.a;
								var pageWidth = _v2.a;
								var bookOffset = _v2.b;
								return $author$project$Pages$HarumiMurakami$Home_$UpdateSelectBookLocations(
									_Utils_Tuple2(pageWidth, bookOffset));
							}
						},
						A2(
							$elm$core$Task$andThen,
							function (pageInfo) {
								return A2(
									...
									function (bookInfo) {
										return $elm$core$Task$succeed(
											_Utils_Tuple2(pageInfo.scene.width, bookInfo.element.x));
									},
									$elm$browser$Browser$Dom$getElement(selectedBookId));
							},
							$elm$browser$Browser$Dom$getElement(pageId))));
			case 'UpdateSelectBookLocations':
				var _v3 = msg.a;
				var pageWidth = _v3.a;
				var bookOffset = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animationData: $elm$core$Maybe$Just(
								{bookOffset: bookOffset, pageWidth: pageWidth})
						}),
					$elm$core$Platform$Cmd$none);
			case 'CloseBook':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: model.fast ? A3($mdgriffith$elm_animator$Animator$go, $mdgriffith$elm_animator$Animator$verySlowly, $author$project$Pages$HarumiMurakami$Home_$Default, model.state) : A3(
								$mdgriffith$elm_animator$Animator$go,
								$mdgriffith$elm_animator$Animator$millis(4000),
								$author$project$Pages$HarumiMurakami$Home_$Default,
								model.state)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							state: function () {
								var _v4 = $mdgriffith$elm_animator$Animator$current(model.state);
								if (_v4.$ === 'Default') {
									return model.state;
								} else {
									var index = _v4.a;
									var book = _v4.b;
									var bool = _v4.c;
									return model.fast ? A3(
										$mdgriffith$elm_animator$Animator$go,
										$mdgriffith$elm_animator$Animator$verySlowly,
										A3($author$project$Pages$HarumiMurakami$Home_$BookOpen, index, book, !bool),
										model.state) : A3(
										$mdgriffith$elm_animator$Animator$go,
										$mdgriffith$elm_animator$Animator$millis(10000),
										A3($author$project$Pages$HarumiMurakami$Home_$BookOpen, index, book, !bool),
										model.state);
								}
							}()
...
var $author$project$UI$black = A3($mdgriffith$elm_ui$Element$rgb255, 25, 25, 27);
var $author$project$Pages$HarumiMurakami$Home_$OpenPreview = {$: 'OpenPreview'};
...
var $author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth = 840;
var $author$project$Pages$HarumiMurakami$Home_$bookDetailRightPadding = 80;
...
var $author$project$UI$lessLightBlue = A3($mdgriffith$elm_ui$Element$rgb255, 146, 208, 216);
...
var $author$project$UI$lightBlue = A3($mdgriffith$elm_ui$Element$rgb255, 232, 244, 250);
...
var $mdgriffith$elm_animator$Animator$linear = F2(
	function (timeline, lookup) {
		return A2(
			...
			timeline,
			A2($elm$core$Basics$composeL, $mdgriffith$elm_animator$Internal$Interpolate$withLinearDefault, lookup)).position;
	});
...
var $author$project$Pages$HarumiMurakami$Home_$CloseBook = {$: 'CloseBook'};
...
var $author$project$UI$withAlpha = F2(
	function (alpha, color) {
		var rgbColor = $mdgriffith$elm_ui$Element$toRgb(color);
		return A4($mdgriffith$elm_ui$Element$rgba, rgbColor.red, rgbColor.green, rgbColor.blue, alpha);
	});
...
var $author$project$Pages$HarumiMurakami$Home_$renderSearchBar = function (model) {
	var searchIcon = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$UI$black),
		...
		$mdgriffith$elm_ui$Element$html(
			A2(
				...
				A2(
					...
					2.4,
					A2($feathericons$elm_feather$FeatherIcons$withSize, 28, $feathericons$elm_feather$FeatherIcons$search)))));
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$UI$withAlpha, 0.2, $author$project$UI$black)),
				$mdgriffith$elm_ui$Element$Border$widthEach(
				{bottom: 2, left: 0, right: 0, top: 0})
			]),
		_List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$el, _List_Nil, searchIcon),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$px(
							$elm$core$Basics$round(
								A2(
									...
									model.state,
									function (state) {
										return _Utils_eq(state, $author$project$Pages$HarumiMurakami$Home_$Default) ? $mdgriffith$elm_animator$Animator$at(140) : $mdgriffith$elm_animator$Animator$at(1);
									}))))
					]),
				$mdgriffith$elm_ui$Element$none)
			]));
};
var $author$project$UI$sidebarHeight = 120;
var $author$project$Pages$HarumiMurakami$Home_$sidebarWidth = 148;
...
var $author$project$Pages$HarumiMurakami$Home_$navbar = F2(
	function (forHome, model) {
		var navigationTitle = forHome ? 'Harumi Murakami' : 'Back';
		var icon = forHome ? $feathericons$elm_feather$FeatherIcons$menu : $feathericons$elm_feather$FeatherIcons$arrowLeft;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$px($author$project$UI$sidebarHeight))
				]),
			A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						...
						{
							bottom: 20,
							left: forHome ? 60 : (60 + $author$project$Pages$HarumiMurakami$Home_$sidebarWidth),
							right: 60,
							top: 20
						}),
				...
				_List_fromArray(
					[
						...
						_List_Nil,
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$Pages$HarumiMurakami$Home_$CloseBook)
						}),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
						...
						$mdgriffith$elm_ui$Element$text(navigationTitle)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$alignRight]),
						$author$project$Pages$HarumiMurakami$Home_$renderSearchBar(model))
					])));
	});
...
var $author$project$UI$raleway = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
...
var $author$project$UI$rubik = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('Rubik'),
			$mdgriffith$elm_ui$Element$Font$sansSerif
		]));
var $author$project$Pages$HarumiMurakami$Home_$renderBookAction = F2(
					...
					$mdgriffith$elm_ui$Element$html(
						A2(
							...
							A2(
								$feathericons$elm_feather$FeatherIcons$withStrokeWidth,
								1,
								A2($feathericons$elm_feather$FeatherIcons$withSize, 36, icon))))),
					$mdgriffith$elm_ui$Element$text(action)
				]));
	});
var $author$project$Pages$HarumiMurakami$Home_$renderMetadata = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color($author$project$UI$lessLightBlue),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
						]),
					...
					_List_fromArray(
						[
							...
							A2($author$project$UI$withAlpha, 0.8, $author$project$UI$black)),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$UI$robotoSlab = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('Roboto Slab'),
...
var $author$project$Pages$HarumiMurakami$Home_$squishFont = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'transform', 'scaleY(0.9)'));
var $mdgriffith$elm_ui$Element$Background$tiled = function (src) {
	return $mdgriffith$elm_ui$Internal$Model$Attr(
		A2($elm$virtual_dom$VirtualDom$style, 'background', 'url(\"' + (src + '\") repeat')));
};
var $author$project$UI$white = A3($mdgriffith$elm_ui$Element$rgb255, 249, 249, 251);
...
var $author$project$Pages$HarumiMurakami$Home_$bookDetailPage = function (model) {
	var scale = A2(
		$mdgriffith$elm_animator$Animator$linear,
		model.state,
		function (state) {
			if (state.$ === 'Default') {
				...
				return $mdgriffith$elm_animator$Animator$at(220 / 180);
			}
		});
	var isOpening = function () {
		var _v5 = $mdgriffith$elm_animator$Animator$current(model.state);
		if (_v5.$ === 'BookOpen') {
			var bool = _v5.c;
			return bool;
		} else {
	...
	var darkGrey = A3($mdgriffith$elm_ui$Element$rgb255, 45, 45, 47);
	var customPercent = function (modifier) {
		return A2(
	...
	var delayedOpenPercent = customPercent(
		A2(
			$elm$core$Basics$composeR,
			$mdgriffith$elm_animator$Animator$leaveSmoothly(0.8),
			$mdgriffith$elm_animator$Animator$arriveSmoothly(0.4)));
	var openPercent = customPercent(
		A2(
			$elm$core$Basics$composeR,
			$mdgriffith$elm_animator$Animator$leaveSmoothly(0.2),
			$mdgriffith$elm_animator$Animator$arriveSmoothly(0.2)));
	var calcRotation = function (percent) {
		var minAsMaximum = (percent > 0.5) ? (2 * (1 - percent)) : (percent * 2);
		return $mdgriffith$elm_ui$Element$htmlAttribute(
			A2(
				$elm$html$Html$Attributes$style,
				'transform',
				'rotateY(' + ($elm$core$String$fromFloat(180 * percent) + ('deg) skewY(' + ($elm$core$String$fromFloat(minAsMaximum * (-10)) + 'deg)')))));
	};
	var page1Animation = isOpening ? calcRotation(openPercent) : calcRotation(delayedOpenPercent);
	var animateOffset = $mdgriffith$elm_ui$Element$htmlAttribute(
		A2(
			$mdgriffith$elm_animator$Animator$Inline$xy,
			model.state,
			function (state) {
				var _v2 = _Utils_Tuple2(state, model.animationData);
				if ((_v2.a.$ === 'Default') && (_v2.b.$ === 'Just')) {
					var _v3 = _v2.a;
					var pageWidth = _v2.b.a.pageWidth;
					var bookOffset = _v2.b.a.bookOffset;
					return {
						x: $mdgriffith$elm_animator$Animator$at(-(((((((pageWidth - $author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth) - $author$project$Pages$HarumiMurakami$Home_$bookDetailRightPadding) - 148) - bookOffset) + 110) + 40) + 8)),
						y: $mdgriffith$elm_animator$Animator$at(160)
					};
				} else {
					return {
						x: $mdgriffith$elm_animator$Animator$at(-110),
						y: $mdgriffith$elm_animator$Animator$at(160)
					};
				}
			}));
	var page1 = $mdgriffith$elm_ui$Element$inFront(
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width(
					$mdgriffith$elm_ui$Element$px(
						$elm$core$Basics$round(180 * scale))),
					$mdgriffith$elm_ui$Element$height(
					$mdgriffith$elm_ui$Element$px(
						$elm$core$Basics$round(270 * scale))),
					$mdgriffith$elm_ui$Element$alignLeft,
					animateOffset,
					$mdgriffith$elm_ui$Element$Events$onClick($author$project$Pages$HarumiMurakami$Home_$OpenPreview)
				]),
			A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$moveDown(180),
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Pages$HarumiMurakami$Home_$OpenPreview),
						$mdgriffith$elm_ui$Element$Background$color(darkGrey),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'transform-origin', 'left')),
						page1Animation
					]),
				$mdgriffith$elm_ui$Element$none)));
	var page2 = $mdgriffith$elm_ui$Element$inFront(
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$moveDown(180),
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Pages$HarumiMurakami$Home_$OpenPreview),
						$mdgriffith$elm_ui$Element$Background$color($author$project$UI$lessLightBlue),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'transform-origin', 'left')),
						isOpening ? calcRotation(delayedOpenPercent) : calcRotation(openPercent)
					]),
				$mdgriffith$elm_ui$Element$none)));
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 225, 214, 205)),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat(
						A2(
							...
							model.state,
							function (state) {
								return _Utils_eq(state, $author$project$Pages$HarumiMurakami$Home_$Default) ? $mdgriffith$elm_animator$Animator$at(0) : $mdgriffith$elm_animator$Animator$at(100);
							})) + 'vw')),
				$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
			]),
		function () {
			var _v0 = model.lastBook;
			if (_v0.$ === 'Nothing') {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							A2($author$project$Pages$HarumiMurakami$Home_$navbar, false, model)),
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							...
							A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Background$tiled('light-noise.svg'),
										$mdgriffith$elm_ui$Element$alpha(0.1),
										$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							...
							A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Background$tiled('dark-noise.svg'),
										$mdgriffith$elm_ui$Element$alpha(0.05),
										$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
									]),
								$mdgriffith$elm_ui$Element$none)),
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$text('Chicago Tribune'))
								])),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$height(
									$mdgriffith$elm_ui$Element$px(610)),
									$mdgriffith$elm_ui$Element$width(
									$mdgriffith$elm_ui$Element$px($author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth)),
									$mdgriffith$elm_ui$Element$alignRight,
									$mdgriffith$elm_ui$Element$alignTop,
									$mdgriffith$elm_ui$Element$moveDown($author$project$UI$sidebarHeight),
									$mdgriffith$elm_ui$Element$Background$color($author$project$UI$white),
									$mdgriffith$elm_ui$Element$inFront(
									A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$alignLeft,
												animateOffset,
												$mdgriffith$elm_ui$Element$Background$color($author$project$UI$lightBlue),
												$mdgriffith$elm_ui$Element$Events$onClick($author$project$Pages$HarumiMurakami$Home_$OpenPreview),
												$mdgriffith$elm_ui$Element$Border$shadow(
												{
													blur: 15,
													color: A2($author$project$UI$withAlpha, 0.2, $author$project$UI$black),
													offset: _Utils_Tuple2(0, 10),
													size: 0
												})
											]),
										$mdgriffith$elm_ui$Element$none)),
									(delayedOpenPercent > 0.5) ? $mdgriffith$elm_ui$Element$moveUp(0) : page2,
									(delayedOpenPercent > 0.5) ? $mdgriffith$elm_ui$Element$moveUp(0) : page1,
									$mdgriffith$elm_ui$Element$inFront(
									A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
										...
										A2(
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$moveDown(140),
													$mdgriffith$elm_ui$Element$htmlAttribute(
													...
													$mdgriffith$elm_ui$Element$Background$color($author$project$UI$lightBlue),
													function () {
													var _v1 = $mdgriffith$elm_animator$Animator$current(model.state);
													if (_v1.$ === 'Default') {
														return $mdgriffith$elm_ui$Element$moveUp(0);
													} else {
														if (!_v1.c) {
															return $mdgriffith$elm_ui$Element$htmlAttribute(
																$elm$html$Html$Attributes$class('sheen'));
														} else {
															return $mdgriffith$elm_ui$Element$moveUp(0);
														}
													}
											...
											{description: 'Cover for ' + book.title, src: book.imageUrl}))),
									((isOpening && (openPercent > 0.5)) || ((!isOpening) && (openPercent > 0.3))) ? page1 : $mdgriffith$elm_ui$Element$moveUp(0),
									(delayedOpenPercent > 0.5) ? page2 : $mdgriffith$elm_ui$Element$moveUp(0)
								]),
							A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$width(
												$mdgriffith$elm_ui$Element$px(
													$elm$core$Basics$round((($author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth - 120) - $author$project$Pages$HarumiMurakami$Home_$sidebarWidth) * (1 - openPercent)))),
												$mdgriffith$elm_ui$Element$clipX
											]),
										A2(
											$mdgriffith$elm_ui$Element$column,
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$width(
													$mdgriffith$elm_ui$Element$px(
														$elm$core$Basics$round(($author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth - 120) - $author$project$Pages$HarumiMurakami$Home_$sidebarWidth))),
													$mdgriffith$elm_ui$Element$paddingEach(
													{
														bottom: 0,
														left: $elm$core$Basics$round(70),
														right: $elm$core$Basics$round(40 * (1 - openPercent)),
														top: 0
													})
												]),
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$text('Haruki Murakami')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
													...
													_List_fromArray(
														[
															A2($author$project$Pages$HarumiMurakami$Home_$renderMetadata, 'Originally Published', 'July 1, 1960'),
															A2($author$project$Pages$HarumiMurakami$Home_$renderMetadata, 'Publisher', 'Shin Publishing')
														])),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
													...
													$mdgriffith$elm_ui$Element$none),
													A2($author$project$Pages$HarumiMurakami$Home_$renderMetadata, 'Categories', 'Fictional, Magical Realism, Asian Literature, Domestic Fiction')
												]))),
										A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
												$mdgriffith$elm_ui$Element$width(
												$mdgriffith$elm_ui$Element$px($author$project$Pages$HarumiMurakami$Home_$sidebarWidth)),
												$mdgriffith$elm_ui$Element$Border$widthEach(
												{
													bottom: 0,
													left: $elm$core$Basics$round(1 - openPercent),
													right: $elm$core$Basics$round(openPercent),
													top: 0
												}),
												$mdgriffith$elm_ui$Element$Border$color(
												A2($author$project$UI$withAlpha, 0.2, $author$project$UI$black))
										...
										A2(
											...
											_List_fromArray(
												[
													A2($author$project$Pages$HarumiMurakami$Home_$renderBookAction, 'Save', $feathericons$elm_feather$FeatherIcons$bookmark),
													A2($author$project$Pages$HarumiMurakami$Home_$renderBookAction, 'Preview', $feathericons$elm_feather$FeatherIcons$playCircle),
													A2($author$project$Pages$HarumiMurakami$Home_$renderBookAction, 'Get Book', $feathericons$elm_feather$FeatherIcons$shoppingBag)
												]))),
										A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$width(
												$mdgriffith$elm_ui$Element$px(
													$elm$core$Basics$round((($author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth - 120) - $author$project$Pages$HarumiMurakami$Home_$sidebarWidth) * openPercent))),
												$mdgriffith$elm_ui$Element$clipX
											]),
										A2(
											$mdgriffith$elm_ui$Element$column,
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$width(
													$mdgriffith$elm_ui$Element$px(
														$elm$core$Basics$round(($author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth - 140) - $author$project$Pages$HarumiMurakami$Home_$sidebarWidth))),
													$mdgriffith$elm_ui$Element$paddingEach(
													{
														bottom: 0,
														left: $elm$core$Basics$round(60),
														right: $elm$core$Basics$round(50),
														top: 0
													}),
													$author$project$UI$rubik
												]),
												...
												[
													...
													_List_fromArray(
														[
															...
															$author$project$UI$rubik,
															$mdgriffith$elm_ui$Element$Font$size(24),
															$author$project$Pages$HarumiMurakami$Home_$squishFont
														]),
													$mdgriffith$elm_ui$Element$text('Excerpt')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
													...
													$mdgriffith$elm_ui$Element$text('Book 1 - Chapter 1')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
													...
													$mdgriffith$elm_ui$Element$text('See full excerpt')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
															...
															{bottom: 2, left: 0, right: 0, top: 0}),
															$mdgriffith$elm_ui$Element$Border$color(
															A2($author$project$UI$withAlpha, 0.3, $author$project$UI$black))
														]),
													$mdgriffith$elm_ui$Element$none)
												])))
									]))),
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$width(
									$mdgriffith$elm_ui$Element$px(
										$elm$core$Basics$round($author$project$Pages$HarumiMurakami$Home_$bookDetailRightPadding * (1 - openPercent)))),
									$mdgriffith$elm_ui$Element$alignRight
								]),
							$mdgriffith$elm_ui$Element$none)
						]));
...
var $author$project$UI$cream = A3($mdgriffith$elm_ui$Element$rgb255, 244, 233, 223);
var $mdgriffith$elm_ui$Element$fillPortion = $mdgriffith$elm_ui$Internal$Model$Fill;
var $author$project$Pages$HarumiMurakami$Home_$onOpenAnimateX = F2(
	function (bookState, fn) {
		return $mdgriffith$elm_ui$Element$htmlAttribute(
			A2(
				$mdgriffith$elm_animator$Animator$Inline$xy,
				bookState,
				function (state) {
					if (state.$ === 'Default') {
						return {
							x: $mdgriffith$elm_animator$Animator$at(0),
							y: $mdgriffith$elm_animator$Animator$at(0)
						};
					} else {
						var bookIndex = state.a;
						return {
...
var $author$project$Pages$HarumiMurakami$Home_$SelectBook = F2(
	function (a, b) {
		return {$: 'SelectBook', a: a, b: b};
	});
var $elm$core$String$foldr = _String_foldr;
var $elm$core$String$fromList = _String_fromList;
var $author$project$Pages$HarumiMurakami$Home_$commaSeparatedInt = function (_int) {
	return A2(
		$elm$core$String$join,
		',',
		A2(
			...
			A3(
				...
				F2(
					function (x, acc) {
						if (acc.b) {
							if (((acc.a.b && acc.a.b.b) && acc.a.b.b.b) && (!acc.a.b.b.b.b)) {
								var _v1 = acc.a;
								var a = _v1.a;
								var _v2 = _v1.b;
								var b = _v2.a;
...
var $author$project$Pages$HarumiMurakami$Home_$starData = _List_fromArray(
	[
		A2(
		$elm$svg$Svg$polygon,
		_List_fromArray(
...
var $author$project$Pages$HarumiMurakami$Home_$svgFeatherIcon = F2(
	function (fillColor, svgData) {
...
var $author$project$Pages$HarumiMurakami$Home_$renderFilledStar = function (attr) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		A2(
			$elm$core$List$cons,
			$mdgriffith$elm_ui$Element$Font$color($author$project$UI$black),
			attr),
		A2($author$project$Pages$HarumiMurakami$Home_$svgFeatherIcon, '#f9af1e', $author$project$Pages$HarumiMurakami$Home_$starData));
};
var $author$project$Pages$HarumiMurakami$Home_$renderStar = function (attr) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		A2(
			$elm$core$List$cons,
			$mdgriffith$elm_ui$Element$Font$color($author$project$UI$black),
			attr),
		A2($author$project$Pages$HarumiMurakami$Home_$svgFeatherIcon, '#00000033', $author$project$Pages$HarumiMurakami$Home_$starData));
};
var $author$project$Pages$HarumiMurakami$Home_$renderBook = F4(
	function (bookState, animationData, index, book) {
		var scale = A2(
			$mdgriffith$elm_animator$Animator$linear,
			bookState,
			function (state) {
				if (state.$ === 'Default') {
					...
					var bookIndex = state.a;
					return _Utils_eq(index, bookIndex) ? $mdgriffith$elm_animator$Animator$at(220 / 180) : $mdgriffith$elm_animator$Animator$at(1);
				}
			});
		var noMovement = {
			x: $mdgriffith$elm_animator$Animator$at(0),
		...
		var animateOffset = $mdgriffith$elm_ui$Element$htmlAttribute(
			A2(
				...
				bookState,
				function (state) {
					var _v0 = _Utils_Tuple2(state, animationData);
					if ((_v0.a.$ === 'BookOpen') && (_v0.b.$ === 'Just')) {
						var _v1 = _v0.a;
						var bookIndex = _v1.a;
						var pageWidth = _v0.b.a.pageWidth;
						var bookOffset = _v0.b.a.bookOffset;
						return _Utils_eq(index, bookIndex) ? {
							x: $mdgriffith$elm_animator$Animator$at((((pageWidth - $author$project$Pages$HarumiMurakami$Home_$bookDetailCardWidth) - $author$project$Pages$HarumiMurakami$Home_$bookDetailRightPadding) - bookOffset) - 110),
							y: $mdgriffith$elm_animator$Animator$at(0)
						} : noMovement;
					} else {
						return noMovement;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id(
						'book-' + $elm$core$String$fromInt(index))),
					$mdgriffith$elm_ui$Element$Events$onClick(
					_Utils_eq(
						$mdgriffith$elm_animator$Animator$current(bookState),
						$author$project$Pages$HarumiMurakami$Home_$Default) ? A2($author$project$Pages$HarumiMurakami$Home_$SelectBook, index, book) : $author$project$Pages$HarumiMurakami$Home_$CloseBook),
					A2(
					$author$project$Pages$HarumiMurakami$Home_$onOpenAnimateX,
					bookState,
					function (bookIndex) {
						return (_Utils_cmp(index, bookIndex) > 0) ? 1000 : (_Utils_eq(index, bookIndex) ? 0 : (-1000));
					}),
					$mdgriffith$elm_ui$Element$height(
				...
				[
					...
					_List_fromArray(
						[
							...
							(!_Utils_eq(
							$mdgriffith$elm_animator$Animator$current(bookState),
							$author$project$Pages$HarumiMurakami$Home_$Default)) ? $mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'z-index', '100')) : $mdgriffith$elm_ui$Element$moveUp(0)
						]),
					{description: 'Cover for ' + book.title, src: book.imageUrl}),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					_List_fromArray(
						[
							...
							bookState,
							function (bookIndex) {
								return _Utils_eq(index, bookIndex) ? 1000 : 0;
							})
						]),
					_List_fromArray(
						[
							...
							_Utils_ap(
								A2(
									$elm$core$List$repeat,
									book.stars,
									$author$project$Pages$HarumiMurakami$Home_$renderFilledStar(_List_Nil)),
								A2(
									$elm$core$List$repeat,
									5 - book.stars,
									$author$project$Pages$HarumiMurakami$Home_$renderStar(_List_Nil)))),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$Font$regular]),
									$mdgriffith$elm_ui$Element$text('See reviews ')),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$Font$light]),
									$mdgriffith$elm_ui$Element$text(
										'(' + ($author$project$Pages$HarumiMurakami$Home_$commaSeparatedInt(book.reviews) + ')')))
								]))
						]))
				]));
	});
...
var $author$project$Pages$HarumiMurakami$Home_$renderBookList = F3(
	function (state, animationData, books) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$class('keep-scrolling')),
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id('book-container')),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'scroll-behavior', ' smooth')),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'overflow-y', 'visible')),
			...
			A2(
				...
				_Utils_ap(
					A2(
						...
						A2($author$project$Pages$HarumiMurakami$Home_$renderBook, state, animationData),
						books),
					_List_fromArray(
						[
							A2(
									...
									A2(
										...
										A2(
											...
											_List_fromArray(
												[
													'calc(100vw - ',
													$elm$core$String$fromInt($author$project$Pages$HarumiMurakami$Home_$sidebarWidth),
													'px - 65px - 65px - 6px - 440px)'
												]))))
								]),
							$mdgriffith$elm_ui$Element$none)
						]))));
...
var $author$project$Pages$HarumiMurakami$Home_$renderIcon = F2(
	function (attr, icon) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			A2(
...
var $author$project$Pages$HarumiMurakami$Home_$renderHeader = function (bookState) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$moveRight(65),
							$mdgriffith$elm_ui$Element$moveUp(60)
						]),
					A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Background$color($author$project$UI$cream),
								A2(
								$author$project$Pages$HarumiMurakami$Home_$onOpenAnimateX,
								bookState,
								$elm$core$Basics$always(-800))
							]),
						$mdgriffith$elm_ui$Element$none))),
				$mdgriffith$elm_ui$Element$behindContent(
				A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$moveRight(1165),
							$mdgriffith$elm_ui$Element$moveUp(60),
							$mdgriffith$elm_ui$Element$alignRight
						]),
					A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$width(
						A2($mdgriffith$elm_ui$Element$maximum, 1000 + 25, $mdgriffith$elm_ui$Element$fill)),
						A2(
						$author$project$Pages$HarumiMurakami$Home_$onOpenAnimateX,
						bookState,
						$elm$core$Basics$always(400))
					]),
				$mdgriffith$elm_ui$Element$text('Most Popular Picks')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$none),
				A2(
				$author$project$Pages$HarumiMurakami$Home_$renderIcon,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$alignLeft,
						$mdgriffith$elm_ui$Element$centerY,
				...
				$feathericons$elm_feather$FeatherIcons$menu),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
...
var $author$project$Pages$HarumiMurakami$Home_$ToggleSpeed = {$: 'ToggleSpeed'};
...
var $author$project$Pages$HarumiMurakami$Home_$sidebar = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$paddingXY, 60, 50),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerY]),
				$feathericons$elm_feather$FeatherIcons$music),
				A2(
				$author$project$Pages$HarumiMurakami$Home_$renderIcon,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerY]),
				$feathericons$elm_feather$FeatherIcons$book),
				A2(
				$author$project$Pages$HarumiMurakami$Home_$renderIcon,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerY]),
				$feathericons$elm_feather$FeatherIcons$bookmark),
				A2(
				$author$project$Pages$HarumiMurakami$Home_$renderIcon,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$alignBottom,
						$mdgriffith$elm_ui$Element$Events$onClick($author$project$Pages$HarumiMurakami$Home_$ToggleSpeed)
					]),
				model.fast ? $feathericons$elm_feather$FeatherIcons$zap : $feathericons$elm_feather$FeatherIcons$zapOff),
				A2(
				$author$project$Pages$HarumiMurakami$Home_$renderIcon,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$alignBottom]),
				$feathericons$elm_feather$FeatherIcons$home)
			]));
};
var $author$project$Pages$HarumiMurakami$Home_$homePage = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Pages$HarumiMurakami$Home_$sidebar(model),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$inFront(
						A2($author$project$Pages$HarumiMurakami$Home_$navbar, true, model)),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
					]),
				A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$none),
							$author$project$Pages$HarumiMurakami$Home_$renderHeader(model.state),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							$mdgriffith$elm_ui$Element$none),
							A3($author$project$Pages$HarumiMurakami$Home_$renderBookList, model.state, model.animationData, model.books),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$html(
										A2(
											...
											A2(
												$feathericons$elm_feather$FeatherIcons$withStrokeWidth,
												1,
												A2($feathericons$elm_feather$FeatherIcons$withSize, 36, $feathericons$elm_feather$FeatherIcons$playCircle))))),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$width(
											$mdgriffith$elm_ui$Element$px(944)),
											$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
										]),
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$el,
											_List_fromArray(
												[$mdgriffith$elm_ui$Element$Font$medium, $author$project$UI$rubik, $mdgriffith$elm_ui$Element$alignTop]),
											$mdgriffith$elm_ui$Element$text('What I Talk About When I Talk About Running')),
											A2(
											$mdgriffith$elm_ui$Element$el,
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$text('Chapter 1')),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_fromArray(
														[
													...
													$mdgriffith$elm_ui$Element$text('14:01 / 18:54'))
												])),
											A2(
											$mdgriffith$elm_ui$Element$row,
											_List_fromArray(
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$mdgriffith$elm_ui$Element$width(
																		$mdgriffith$elm_ui$Element$fillPortion(13))
																	]),
																$mdgriffith$elm_ui$Element$none),
																A2(
																$mdgriffith$elm_ui$Element$el,
																_List_fromArray(
																	[
																		$mdgriffith$elm_ui$Element$Background$color(
																		A3($mdgriffith$elm_ui$Element$rgb255, 127, 194, 205)),
																		$mdgriffith$elm_ui$Element$width(
...
var $author$project$Pages$HarumiMurakami$Home_$view = function (model) {
	return {
		element: A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$style, 'transition', 'color 200ms, background-color 200ms')),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					...
					$mdgriffith$elm_ui$Element$Background$color($author$project$UI$white),
					$mdgriffith$elm_ui$Element$inFront(
					$author$project$Pages$HarumiMurakami$Home_$bookDetailPage(model))
				]),
			_List_fromArray(
				[
					$author$project$Pages$HarumiMurakami$Home_$homePage(model)
				])),
		title: 'Home'
	};
};
var $author$project$Pages$HarumiMurakami$Home_$page = F2(
	function (shared, req) {
		return $author$project$Page$element(
			{
				init: A2($author$project$Pages$HarumiMurakami$Home_$init, req, shared.pageOptions),
				subscriptions: function (model) {
					return A3($mdgriffith$elm_animator$Animator$toSubscription, $author$project$Pages$HarumiMurakami$Home_$Tick, model, $author$project$Pages$HarumiMurakami$Home_$animator);
				},
				update: $author$project$Pages$HarumiMurakami$Home_$update,
				view: $author$project$Pages$HarumiMurakami$Home_$view
			});
	});
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				{
					...
					url: $author$project$Gen$Route$toHref($author$project$Gen$Route$HarumiMurakami__Home_)
				}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$size(244),
...
var $author$project$Gen$Pages$pages = {
	harumiMurakami__home_: A3($author$project$Gen$Pages$bundle, $author$project$Pages$HarumiMurakami$Home_$page, $author$project$Gen$Model$HarumiMurakami__Home_, $author$project$Gen$Msg$HarumiMurakami__Home_),
...
var $author$project$Gen$Pages$init = function (route) {
	if (route.$ === 'NotFound') {
		...
		return $author$project$Gen$Pages$pages.harumiMurakami__home_.init(_Utils_Tuple0);
	}
};
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		default:
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.harumiMurakami__home_.subscriptions, params, model);
	}
};
...
var $author$project$Gen$Pages$update = F2(
	function (msg_, model_) {
		...
		if (_v0.b.$ === 'HarumiMurakami__Home_') {
			var msg = _v0.a.a;
			var _v1 = _v0.b;
			var params = _v1.a;
			var model = _v1.b;
			return A3($author$project$Gen$Pages$pages.harumiMurakami__home_.update, params, msg, model);
		} else {
			return F3(
		...
		if (msg.$ === 'NoOp') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						pageOptions: _Utils_update(
							pageOptions,
							{isDark: !model.pageOptions.isDark})
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		default:
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.harumiMurakami__home_.view, params, model);
	}
};
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Gen.Pages.Msg":{"args":[],"type":"Gen.Msg.Msg"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Models.Book.Book":{"args":[],"type":"{ imageUrl : String.String, title : String.String, stars : Basics.Int, reviews : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangedUrl":["Url.Url"],"ClickedLink":["Browser.UrlRequest"],"Shared":["Shared.Msg"],"Page":["Gen.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Gen.Msg.Msg":{"args":[],"tags":{"HarumiMurakami__Home_":["Pages.HarumiMurakami.Home_.Msg"]}},"Shared.Msg":{"args":[],"tags":{"NoOp":[],"ToggleDarkMode":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.HarumiMurakami.Home_.Msg":{"args":[],"tags":{"NoOp":[],"Tick":["Time.Posix"],"SelectBook":["Basics.Int","Models.Book.Book"],"UpdateSelectBookLocations":["( Basics.Float, Basics.Float )"],"CloseBook":[],"ToggleSpeed":[],"OpenPreview":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});}(this));